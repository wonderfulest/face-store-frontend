...
const Privacy = () => (
  <div className="privacy-pro-wrapper">
    <div className="privacy-pro-header">
      {/* 如有 React 版 Logo 组件可替换此处 */}
      {/* <Logo /> */}
      <div className="privacy-meta">
        <h1 className="privacy-title">Privacy Policy</h1>
        {/* <span className="privacy-breadcrumb">Home / Privacy Policy</span> */}
        <span className="privacy-updated">Last Updated: 2025-06-05</span>
      </div>
    </div>
