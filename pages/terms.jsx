...
// import Logo from "@/components/Logo" // 如有 React 版 Logo 组件可取消注释

const Terms = () => (
  <div className="terms-pro-wrapper">
    <div className="terms-pro-header">
      {/* 如有 React 版 Logo 组件可替换此处 */}
      {/* <Logo /> */}
      <div className="terms-meta">
        <h1 className="terms-title">Website Terms of Use</h1>
        {/* <span className="terms-breadcrumb">Home / Terms of Use</span> */}
        <span className="terms-updated">Last Updated: 2025-06-05</span>
      </div>
    </div>
    ...
    <div className="terms-content">
      ...
      <p>We want you to be completely satisfied with your purchase. If you are not satisfied for any reason, you can request a refund within <strong>14 days</strong> of your purchase date. No questions asked.</p>
      <ul>
        ...
        <li>Refunds are typically processed within <strong>3-5 business days</strong> after your request is approved. The actual time for the funds to appear in your account may vary depending on your payment provider.</li>
      ...
      <p>If you have any questions about our refund policy or need assistance, please contact us at <a href="mailto:support@wristo.io">support@wristo.io</a>.</p>
